...
class yolov5_tflite:
    ...
    def nms(self,prediction):
        ...
        for r in res:
            ...
            result_class_names.append([np.argmax(prediction[r,5:])])

        
        return result_boxes, result_scores, result_classes,result_class_names
    ...
    def detect(self,image):
        ...
        result_boxes, result_scores, result_classes, result_class_names = self.nms(pred)

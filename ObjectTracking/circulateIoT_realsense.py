...
myMQTTClient = createMQTTClient('RealSense',endPoint,credentials)
...
def detect_image(weights,
    ...
    with open('/home/intelligentmedicine/Desktop/CirculateEdge/ObjectTracking/class_names.txt') as f:
    ...
    json_file_path ='/home/intelligentmedicine/Desktop/CirculateEdge/ObjectTracking/HighDensityPreset.json'
    ...
    PERIOD_OF_TIME = 3600*2
    on_time = time.time()
    while True:
        if time.time() - on_time > PERIOD_OF_TIME:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-w','--weights', type=str, default='/home/intelligentmedicine/Desktop/CirculateEdge/ObjectTracking/headdetection.tflite', help='model.tflite path(s)')
    ...
    if opt.save_path == 'True':
        ...
        os.makedirs(PATH + "/Unannotated")
    cnt = 0
    detect_image(opt.weights,opt.img_size,opt.conf_thres,opt.iou_thres,PATH,cnt,myMQTTClient)
